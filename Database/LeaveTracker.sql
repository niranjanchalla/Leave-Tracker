...
/****** Object:  Database [LMS]    Script Date: 09/03/2014 10:35:32 ******/
CREATE DATABASE [LMS] ON  PRIMARY 
( NAME = N'LMS', FILENAME = N'c:\Program Files (x86)\Microsoft SQL Server\MSSQL10_50.MYOBACCT\MSSQL\DATA\LMS.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'LMS_log', FILENAME = N'c:\Program Files (x86)\Microsoft SQL Server\MSSQL10_50.MYOBACCT\MSSQL\DATA\LMS_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
